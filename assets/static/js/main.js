$(document).ready(function() {
   var sandwich = function() {
      $(document).on("click", ".catalog-nav__header", function() {
         ...
         if ($(window).width() < 768) {
            if (
               $(".mobile-nav__wrapper").hasClass("mobile-nav__wrapper--active")
            ) {
               $(".mobile-nav__wrapper").removeClass(
      ...
      if ($(window).width() < 768) {
         $(document).on("click", ".sandwich", function() {
            if ($(".catalog-nav").hasClass("catalog-nav--active")) {
               ...
               $(".mobile-nav__wrapper").toggleClass(
                  "mobile-nav__wrapper--active"
               );
            } else {
               $(this).toggleClass("catalog-nav--active");
   ...
   var locationChoose = function() {
      ...
      $(document).on(
         "click",
         ".location-choose__item, .location-choose__close",
         function() {
            $(this)
               .closest(".location__body")
   ...
   var catalogMobileNav = function() {
      catalogNavToggle(
         ".catalog-mobile-nav__label",
         "catalog-mobile-nav__item--active"
      );
      catalogNavToggle(
         ".catalog-mobile-subnav__label",
         "catalog-mobile-subnav__item--active"
      );
   };
   ...
   var scrollColorCatalog = function() {
      $(".colors-catalog").scroll(function() {
         ...
         if (
            $(this).scrollTop() > 0 &&
            !$(this).hasClass("colors-catalog--scrolled")
         ) {
   ...
   var tabs = function() {
      $(".tabs-list__item").click(function() {
         ...
         if ($(this).hasClass("js-tabs--aside")) {
            $(this)
               .closest(".sub-category__aside")
               .addClass("sub-category__aside--active");
            if ($(this).hasClass("tabs-list__item--active")) {
               $(this)
                  .closest(".sub-category__aside")
                  .removeClass("sub-category__aside--active");
               $(this)
                  .toggleClass("tabs-list__item--active")
                  .siblings()
                  .removeClass("tabs-list__item--active");
            }
         }
         if (!$(this).hasClass("tabs-list__item--active")) {
   ...
   var cabinetMobileNav = function() {
      $(document).on("click", ".cabinet-nav__item--active", function(evt) {
         evt.preventDefault();
         $(this)
            .closest(".cabinet-nav__list")
            .toggleClass("cabinet-nav__list--active");
      });
   };
   ...
   var productPrevSlider = function() {
      ...
      productSlider.on("init afterChange", function(
         event,
         slick,
         currentSlide
      ) {
   ...
   var popularCategoriesSlider = function() {
      ...
      if (
         $(window).width() < 768 &&
         !sliderElement.hasClass("slick-initialized")
      ) {
         sliderElement.slick({
            slidesToShow: 1,
            slidesToScroll: 1,
